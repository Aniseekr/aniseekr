...
export function unifiedToLegacyAnime(item: UnifiedAnimeItem): Anime {
  ...
  return {
    ...
    titleJapanese: item.titleJapanese ?? undefined,
    titleChinese: item.titleChinese ?? undefined,
    titleChineseTraditional: item.titleChineseTraditional ?? undefined,
    titleRussian: item.titleRussian ?? undefined,
...
function mapAniListToAnime(item: AniListAnime): Anime {
  return {
    ...
    titleEnglish: item.title.english || undefined,
    titleRomaji: item.title.romaji || undefined,
