...
export const sheetEnter = () =>
  FadeInUp.duration(260).easing(Easing.out(Easing.cubic));

export const sheetExit = () => FadeOutDown.duration(180);
...
export const listItemEnter = (index: number, stagger = 40) =>
  FadeInUp.delay(index * stagger).duration(280).easing(Easing.out(Easing.cubic));

export const listItemEnterDown = (index: number, stagger = 40) =>
  FadeInDown.delay(index * stagger).duration(280).easing(Easing.out(Easing.cubic));
