...
interface PilgrimageJournalScreenProps {
  tabRoot?: boolean;
}

export default function PilgrimageJournalScreen({ tabRoot = false }: PilgrimageJournalScreenProps) {
    ...
    if (selectedAnimeId) {
      ...
      router.push(
        buildPilgrimageDetailRoute(selectedAnimeId, {
          returnTo: tabRoot ? 'explorer-journal' : 'album',
      ...
      <SafeAreaView style={{ flex: 1 }} edges={['top']}>
        ...
        <View
          style={[
            styles.fabWrap,
            {
              bottom: tabRoot ? floatingTabBarOverlayBottom(insets.bottom) : insets.bottom + 18,
            },
          ]}>
          <Pressable
            onPress={handleAddNew}
